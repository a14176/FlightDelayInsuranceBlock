...
contract FlightSuretyApp {
    ...
    uint8 private constant STATUS_CODE_LATE_AIRLINE = 20; // payout insurance for this code
    ...
    modifier requireInsuranceLimit() {
        require(
            ...
            "Pax Insurance is more than the limit price"
        );
        _;
    }

    modifier requireNotAirline(address _airlineAddress) {
        require(
    ...
    modifier requirePaxInsurancePayoutAvailable() {
        require(
            flightSuretyData.isPaxInsurancePayoutAvailable(msg.sender),
            "No PaxInsurancePayoutAvailable"
        );
        _;
    }
    ...
    function isOperational() public view returns (bool) {
        return flightSuretyData.isOperational(); // call the data contract's status
    }
     ...
     *
     */
    function registerAirline(address airline, string memory _name)
        external
        ...
        returns (bool success)
    {
        ...
        if (operationalAirlines < 4) {
            ...
            flightSuretyData.registerAirline(airline, _name, false);
        }
